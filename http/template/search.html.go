...
// source: /Users/jinmatt/go/src/github.com/jinmatt/twtrgo/http/template/src/search.html
// DO NOT EDIT!
package template
...
func RenderSearch(keyword string, tweets []*twtrgo.Tweet, w io.Writer) {
...
`)
    ...
    <div class="row">
      <div class="col">
        <h5 class="lead mb-0 pl-1">Top results for <em>"`)
	hero.EscapeHTML(keyword, _buffer)
	_buffer.WriteString(`</em>"...</h5>
      </div>
    </div>
